/**
 * $Id: TestUInt.cs 21 2008-06-08 07:07:49Z outburst $
 * 
 * STDFSharpTests
 *
 * File: TestUInt.cs
...
namespace KA.StdfSharp.Tests.Record.Field
{
    ...
    {
        private IField<uint> field = null;
        ...
        {
            Assert.AreEqual(uint.MaxValue, field.Value);
            field.Validate();
        ...
        {
            Assert.AreEqual(sizeof(uint), field.Size);
        }
    }
}